...
//
// // ---------------------------------------------------------------
// // RemoteScaffold Widget
// // Assumes props structure like:
// // {
// //   "type": "scaffold",
// //   "hash": "...",
// //   "backgroundColor": "Colors.white" | "null" | "#FF0000" | ...,
// //   "appBar": "hash-of-appbar-node" | "null",
// //   "body": "hash-of-body-node" | "null",
// //   "floatingActionButton": "hash-of-fab-node" | "null",
// //   "drawer": "hash-of-drawer-node" | "null",
// //   "endDrawer": "hash-of-enddrawer-node" | "null",
// //   "bottomNavigationBar": "hash-of-bottomnav-node" | "null",
// //   ...
// // }
// // ---------------------------------------------------------------
...
//   // var body;
//
//   const RemoteScaffold({super.key, required this.hash});
//
...
//
//             case 'appbar':
//               props['appBar'] = childHash;
//               break;
//
//             case 'floatingActionButton':
//               props['floatingActionButton'] = childHash;
//               break;
//
//             case 'drawer':
//               props['drawer'] = childHash;
//               break;
//
//             case 'endDrawer':
//               props['endDrawer'] = childHash;
//               break;
//
//             case 'bottomNavigationBar':
//               props['bottomNavigationBar'] = childHash;
//               break;
//
//             // -------------------------
...
//     }
//
//     props['bodyChildren'] = bodyChildren;
//
//     print('Scaffold: $hash');
//     print('appBar: ${props['appBar']}');
//     print('body: $bodyChildren');
//
//     return RemoteScaffold(hash: hash);
//   }
//
...
//
//         String? childHash(String key) {
//           final value = props[key]?.toString();
//
...
//         }
//
//         final appBarHash = childHash('appBar');
//         final fabHash = childHash('floatingActionButton');
//         final drawerHash = childHash('drawer');
//         final endDrawerHash = childHash('endDrawer');
//         final bottomNavHash = childHash('bottomNavigationBar');
//
//         final List<String> bodyChildren =
//             (props['bodyChildren'] as List?)
//                 ?.map((e) => e.toString())
//                 .where((e) => e.isNotEmpty && e != 'null')
//                 .toList() ??
//             [];
//
//         return Scaffold(
//           backgroundColor: parseColor(props['backgroundColor']?.toString()),
//
//           appBar: appBarHash != null
//               ? renderNode(appBarHash) as PreferredSizeWidget
//               : null,
//
...
//                       .map((hash) => renderNode(hash))
//                       .toList(),
//                 ),
//
//           floatingActionButton: fabHash != null ? renderNode(fabHash) : null,
//
//           drawer: drawerHash != null ? renderNode(drawerHash) : null,
//
//           endDrawer: endDrawerHash != null ? renderNode(endDrawerHash) : null,
//
//           bottomNavigationBar: bottomNavHash != null
//               ? renderNode(bottomNavHash)
//               : null,
//         );
//       },
//     );
